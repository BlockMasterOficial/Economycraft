...
<span style="font-size: 14px;">✔ Machine building with Create!</span>  
<span style="font-size: 14px;">✔ Emotes and animations!</span>  
<span style="font-size: 14px;">✔ Custom quests available in en_US, pt_BR and pt_PT languages!</span>  
<span style="font-size: 14px;">✔ Over 270 mods!</span>  
<span style="font-size: 14px;">✔ Extremely optimized!</span>
...
<span style="font-size: 14px;">✔ Construção de máquinas com Create!</span>  
<span style="font-size: 14px;">✔ Emotes e animações!</span>  
